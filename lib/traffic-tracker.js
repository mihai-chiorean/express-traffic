...
/**
 * @method logger
 * @description Generates the middleware function that logs traffic to a store
 *      available options: 'mongodb', 'stdout'
 *
 * @param {Object} options {out: 'mongodb'|'stdout', [config: {url:'localhost', [db: 'loadmeter']}]}
 * @returns {Function}
 */
